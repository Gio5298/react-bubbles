...
- [ ] Explain what a token is used for.
    A: A token is used to get access to a secure database.
- [ ] What steps can you take in your web apps to keep your data secure?
    A: Back up your data, run a significant amount of tests, have a strong password policy.
- [ ] Describe how web servers work.
    A: The function of a web server is to store, process and deliver web pages to clients.
